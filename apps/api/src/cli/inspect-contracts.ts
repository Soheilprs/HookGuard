...
import { runContractIntelligence } from '../modules/contracts/contract.worker.js';
...
async function main(): Promise<void> {
  ...
  console.info('HookGuard contract intelligence (read-only, no signing)');
