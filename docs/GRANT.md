...
| 7D | External interaction map: CALL targets, ERC-20 selectors, curated protocols |
...
Phase 7D interactions: **19** callback ERC-20 movement selectors, **4** calldata-derived targets, **0** curated protocol matches, **39** unknown/dynamic CALL targets. Targets are unrecovered constants when Solidity uses memory rather than a bare PUSH20.
